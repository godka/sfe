...
Private Sub cmdok_Click()
    ...
    kk.data(1) = userX.Value + userY.Value * 2 + userW.Value * 4 + userH.Value * 8 + userAlpha.Value * 16
    kk.data(2) = userX.Text
    kk.data(3) = userY.Text
    kk.data(4) = userW.Text
    kk.data(5) = userH.Text
    kk.data(6) = userAlpha.Text
...
Dim s1 As String
    ...
    userAlpha.Value = IIf((kk.data(1) And &H10) > 0, 1, 0)
